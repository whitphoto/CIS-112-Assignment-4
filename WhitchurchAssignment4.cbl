      ...
      ***************************************************************** 
       ...
       file-control.
           Select store-data assign to "infile.txt"
       ...
       01 store-rec.
           05 terr-num-in  pic 9(2).
           05 area-num-in  pic 9(2).
           05 dept-num-in  pic 9(2).
       ...
       01 summary-line-1.
           ...
           05 good-rec-out pic zz9. 
           05 filler       pic x(26) value spaces.
       01 summary-line-2.
           05 filler       pic x(11) value spaces.
           05 filler       pic x(12) value 'BAD RECORDS:'.
           05 bad-rec-out  pic zz9.
       
       01 ws-good-rec-ctr  pic 999 value 0.
       
       01 ws-bad-rec-ctr   pic 999 value 0.
       ...
       200-validate.
           ...
           if dept-num-in not = 1 and 2 and 3 and 4     
            and 5 and 6 and 7 and 8 and 9 and 10
               move 'DEPARTMENT' to field-out
               move dept-num-in to data-out
               move 'OUT OF RANGE' to err-msg-out
               write report-rec from detail-line
